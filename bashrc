...
#mount and unmounting usb
alias usbmount="sudo mount /dev/sdc /media/usb"
alias usbunmount="sudo umount /media/usb"

PS1="$(tput setaf 230)\u";
PS1+="$(tput setaf 117)@\h";
PS1+="$(tput setaf 193)\w -->  ";
PS1+="$(tput sgr0)";
export PS1;
